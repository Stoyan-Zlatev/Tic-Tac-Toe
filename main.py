...
class Game:
    def __init__(self):
        ...
        self.menu_state = 'main_menu'  # 'main_menu', 'difficulty_menu', 'game'
        self.game_mode = None  # 'human', 'easy', 'medium', 'hard'

    def new_game(self):
        if self.game_mode == 'human':
            self.tic_tac_toe = TicTacToe(self, game_mode='human')
        else:
            self.tic_tac_toe = TicTacToe(self, game_mode='ai', difficulty=self.game_mode)
